...
def cleanResume(txt):
    ...
    cleanText = re.sub(r'\b(RT|cc)\b', ' ', cleanText)  # Remove "RT" and "cc" only if they are standalone words
    ...
    cleanText = re.sub(r'\s+', ' ', cleanText).strip()  # Normalize whitespace and strip leading/trailing spaces
    return cleanText
